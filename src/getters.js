...
export default { flashSuccess, flashError, flashMessageVisisble, equipment, equipmentValid, operations, materials, material, validMaterial, availableAtStorageLocation, job, jobValid, materialsForSubmit }
